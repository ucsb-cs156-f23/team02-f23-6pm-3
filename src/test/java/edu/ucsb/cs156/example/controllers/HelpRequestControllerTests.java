...
public class HelpRequestControllerTests extends ControllerTestCase {
    ...
    public void logged_in_user_can_get_all_helprequests() throws Exception {
        ...
        LocalDateTime rqt2 = LocalDateTime.parse("2022-03-11T00:00:00");
    ...
    public void an_admin_user_can_post_a_new_helprequest() throws Exception {
        ...
        // act 
        MvcResult response = mockMvc.perform(post("/api/helprequest/post?requesterEmail=cgaucho@ucsb.edu&teamId=s22-5pm-3&tableOrBreakoutRoom=7&requestTime=2022-01-03T00:00:00&explanation=Need help with Swagger-ui&solved=true")
