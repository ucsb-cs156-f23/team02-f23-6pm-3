    ...
    @Test
        ...
        public void an_admin_user_can_post_a_new_helprequest() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/helprequest/post?requesterEmail=admin@gmail.com&teamId=team07&tableOrBreakoutRoom=table&requestTime=2022-01-03T00:00:00&explanation=help&solved=true")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
