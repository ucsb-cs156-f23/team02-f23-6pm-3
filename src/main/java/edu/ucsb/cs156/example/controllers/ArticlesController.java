...
public class ArticlesController extends ApiController {
    ...
    public Article getById(
            @Parameter(name="id", description="The autogenerated id that identifies an article", example="42") @RequestParam Long id) {
    ...
    public Object deleteArticle(
            @Parameter(name="id", description="The autogenereated id that identifies an article") @RequestParam Long id) {
        Article article = articleRepository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException(Article.class, id));
